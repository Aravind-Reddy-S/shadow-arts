...
export default function CartDrawer() {
  ...
  const handleCheckout = () => {
    ...
    toast({
      ...
      description: "Online orders will open soon!"
    });
    ...
    <Sheet>
      ...
      <SheetTrigger asChild>
        ...
        <Button
          variant="ghost"
          size="icon"
          className="relative text-primary-foreground/80 hover:text-secondary hover:bg-primary-foreground/5"
        >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <button
                        ...
                        className="p-1 hover:bg-destructive/20 rounded ml-auto"
                      >
